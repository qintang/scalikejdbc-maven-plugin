 ...
 */
public class ScalikejdbcMetaDataExporter {
    ...
    private final SQLCodegenModule module = new ScalikejdbcSQLCodegenModule();
    ...
    public ScalikejdbcMetaDataExporter() {}
    ...
    private void write(Serializer serializer, String path, EntityType type) throws IOException {
        ...
        CodeWriter writer = createScalaSources ? new ScalikejdbcScalaWriter(w) : new JavaWriter(w);
